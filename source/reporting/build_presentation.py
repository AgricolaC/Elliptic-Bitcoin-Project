...
code(
    ...
    "colors = ['#ff4757', '#2ed573', '#f1f2f6']\n"
    "explode = (0.05, 0.05, 0.05)\n"
    "fig, ax = plt.subplots(figsize=(6, 6))\n"
    "wedges, texts, autotexts = ax.pie(sizes, explode=explode, labels=labels, colors=colors, autopct='%1.1f%%', shadow=False, startangle=140, pctdistance=0.82, textprops={'fontsize': 11, 'color': '#2f3542'}, wedgeprops={'edgecolor': 'white', 'linewidth': 2})\n"
    "for autotext in autotexts:\n"
    "    autotext.set_weight('bold')\n"
    "center_circle = plt.Circle((0,0), 0.70, fc='white')\n"
    "fig.gca().add_artist(center_circle)\n"
    "ax.axis('equal')\n"
    "ax.set_title('Global Class Distribution', fontsize=14, fontweight='bold', color='#2f3542', pad=15)\n"
    "plt.show()"
)
